...
def constructBayesNet(gameState: hunters.GameState):
    ...
    print(X_RANGE)
    print(Y_RANGE)
    variableDomainsDict[OBS0]=[ i for i in range(manhattanDistance((X_RANGE,Y_RANGE),(0,0))+MAX_NOISE)]
    variableDomainsDict[OBS1]=[ i for i in range(manhattanDistance((X_RANGE,Y_RANGE),(0,0))+MAX_NOISE)]
    print(variables)
    print(edges)
